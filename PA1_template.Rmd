...
barplot(totalSteps,las=2,cex.names=.75)
```
...
```
The 5-minutes interval with the maximum number of steps is `r maxInterval`
...
```
The number of missing values is `r rowsWithNA`
